...
- The ontology, SHACL shapes, SPARQL manifest, and example graph parse correctly.
...
2. Create the public GitHub repository under a personal user account if Ontoology support is required.
3. Push the curated repository.
4. Connect the repository to Ontoology.
5. Merge the documentation pull request generated by Ontoology.
